...
from apiapp.serializers import UserSerializer, LessonSerializer, CourseTypeSerializer
from mainapp.models import LessonType, Lesson, CourseType
				...
				for user in users:
					...
					try:
						teachers = LessonType.objects.filter(
							user=user,
							course_type__name=self.request.query_params.get("course_type"))
